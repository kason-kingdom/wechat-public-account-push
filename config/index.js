export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wx5d500fcd603f163d",

  // 公众号APP_SECRET
  APP_SECRET: "299debaf7af928ac1d51c56f5a146f2f",
  ...
  USERS: "oJylF6BzVPT23xow0UDYoxznECTE"
    {
      ...
      name: "何总",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oJylF6DyInDjZlVEPgty-AkXrERA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "7AVOTVvq_4KGQ6gwB5qjQfN4FJ_J6zlWpOBz-MUzUis",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "潮州",
